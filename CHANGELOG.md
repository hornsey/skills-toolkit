...
## [2026-06-15] - 文档继续完善与索引更新

### 🎉 新增 Skills

| 序号 | 名称 | 分类 | 说明 |
|------|------|------|------|
| 1 | document-skills | Agent增强 | Anthropic 官方文档处理技能包 |
| 7 | baoyu-post-to-wechat | 内容创作 | 公众号自动发布与内容整理 |
| 13 | AI Daily Digest | 信息情报 | 自动生成 AI / 技术资讯日报 |
| 21 | OpenClaw Agent Optimize | Agent增强 | OpenClaw Agent 成本与可靠性优化 |
| 22 | Tavily AI Search（分类索引版） | 信息情报 | 指向规范文档的分类索引页 |
| 25 | baoyu-comic | 内容创作 | 将知识内容改写为漫画脚本与分镜 |
| 28 | roundtable | 营销商业 | 多角色辩论式问题分析 Skill |
| 29 | ai-news-zh（分类索引版） | 信息情报 | 指向规范文档的中文 AI 资讯索引页 |
| 30 | Content Creator | 内容创作 | 中文内容选题、写作与润色助手 |
| 31 | SoulTrace | Agent增强 | 用户人格与沟通偏好测评 Skill |
| 39 | Aihot skill | 信息情报 | 获取每日 AI HOT 资讯与动态汇总 |
| 40 | guizang-ppt-skill | 内容创作 | 文章转网页式 PPT 展示技能 |

### 📝 更新 Skills

| 序号 | 名称 | 更新内容 |
|------|------|---------|
| 4 | mckinsey-consultant | 重写文档结构，补充问题拆解、咨询式分析方法、适用边界与来源信息 |
| 26 | validate-idea | 扩充创业想法验证流程，补充触发方式、验证逻辑、风险与适用场景 |
| 27 | marketing-ideas | 补强产品上下文依赖、营销策略框架、选型方式与相关链接 |

### 🔧 优化

- 更新 `docs/index.md` 的项目状态描述，将“已完善文档数量”同步到最新进度
- 补齐多篇分类页详情文档，减少首页可见条目与分类落地页之间的信息落差
- 新增信息情报类的“分类索引版”页面，避免同一 Skill 在索引页中无落点链接
